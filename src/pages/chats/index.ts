...
Handlebars.registerHelper('chats', () => {
	return [
		{ name: 'ken-1', avatar: userAvatar, lastMessage: 'wanna toothpick? wanna toothpick? wanna toothpick? wanna toothpick? wanna toothpick? wanna toothpick?', time: '15:12', unreadCount: 2 },
